...
export const WINDOW_TITLES: Record<WindowType, string> = {
  scanner: 'Scanner', chart: 'Chart', quotes: 'Bid / Ask', toplist: 'Rankings', screener: 'Screener', news: 'News',
...
export const WINDOW_ICONS: Record<WindowType, string> = {
  scanner: '◎', chart: '⌇', quotes: '⇵', toplist: '≡', screener: '⌕', news: '¶', stockinfo: 'ℹ', watchlist: '☆', clock: '◷', setupcheck: '✓',
}
...
export const WINDOW_SIZES: Record<WindowType, WindowSize> = {
  ...
  quotes: { w: 760, h: 440, minW: 420, minH: 240 },
...
export function windowDefaults(type: WindowType, id: string): WindowConfig {
  switch (type) {
    ...
    case 'quotes':
      return { ...base(id, 'quotes'), type: 'quotes', symbol: null }
    case 'toplist':
...
export const USES_LINK: Record<WindowType, boolean> = {
  scanner: true, chart: true, quotes: true, toplist: true, screener: true, news: true, stockinfo: true, watchlist: true, clock: false, setupcheck: true,
}
/** Windows that can make noise. */
export const USES_SOUND: Record<WindowType, boolean> = {
  scanner: true, chart: false, quotes: false, toplist: true, screener: false, news: false, stockinfo: false, watchlist: false, clock: false, setupcheck: false,
}
